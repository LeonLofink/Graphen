...
public class Config {
    ...
    public final static int WINDOW_HEIGHT = Toolkit.getDefaultToolkit().getScreenSize().height;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
